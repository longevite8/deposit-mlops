...
TEMPLATE_EXTRACT_ID = env_template_id(
    "TEMPLATE_EXTRACT_ID", "ef8f0b2c46a24992b2148be808b96152"
)
TEMPLATE_FEATURE_ID = env_template_id(
    "TEMPLATE_FEATURE_ID", "72e62cd11ac14ce2b5c1afd5f2d13eff"
)
TEMPLATE_VALIDATE_ID = env_template_id(
    "TEMPLATE_VALIDATE_ID", "0e04d22044024c02b3907e2693a2042b"
)
TEMPLATE_DRIFT_ID = env_template_id(
    "TEMPLATE_DRIFT_ID", "ef0f33ce2aaa4052979d1ed4cd003a5d"
)
TEMPLATE_HPO_ID = env_template_id("TEMPLATE_HPO_ID", "b72f4cc744a04fa2949c5ee6f64290e6")
TEMPLATE_TRAIN_ID = env_template_id(
    "TEMPLATE_TRAIN_ID", "e5b2461df5ee4255b7d24ad056116dab"
)
TEMPLATE_EVALUATE_ID = env_template_id(
    "TEMPLATE_EVALUATE_ID", "b2c296d5984c4e15be9578187596b16d"
)
TEMPLATE_REGISTER_ID = env_template_id(
    "TEMPLATE_REGISTER_ID", "993f94f8c80349f393722f999f75ba38"
)
TEMPLATE_COMPARE_CHAMPION_ID = env_template_id(
    "TEMPLATE_COMPARE_CHAMPION_ID", "8ca0923d1ca143dc854b10d137579a0b"
)
TEMPLATE_PROMOTE_CHAMPION_ID = env_template_id(
    "TEMPLATE_PROMOTE_CHAMPION_ID", "e716b186d4c24668b4dab727d3e86d6d"
)
TEMPLATE_INFERENCE_ID = env_template_id(
    "TEMPLATE_INFERENCE_ID", "40e0d11642614c58b8075714eead0034"
)
TEMPLATE_MONITORING_ID = env_template_id(
    "TEMPLATE_MONITORING_ID", "f941fdc28c2440e9acccf51838aff3ad"
)
TEMPLATE_ALERTING_ID = env_template_id(
    "TEMPLATE_ALERTING_ID", "4300f9b4b33d46df8bbe7a7ab33e4658"
)
TEMPLATE_AUTO_RETRAINING_ID = env_template_id(
    "TEMPLATE_AUTO_RETRAINING_ID", "d3534c1c2f8b4f55a3f31527522b9f49"
)
TEMPLATE_EXPLAIN_ID = env_template_id(
    "TEMPLATE_EXPLAIN_ID", "7fc2a1271760456e80cbb2eaf4416470"
)
TEMPLATE_DEPLOY_SERVING_ID = env_template_id(
    "TEMPLATE_DEPLOY_SERVING_ID", "6897fdbcaecc41d397608e27a3b54339"
)
TEMPLATE_VERIFY_ENDPOINT_ID = env_template_id(
    "TEMPLATE_VERIFY_ENDPOINT_ID", "c0fb748984234a3c98a48415ed47303d"
)
TEMPLATE_DEPLOY_CANDIDATE_SERVING_ID = env_template_id(
    "TEMPLATE_DEPLOY_CANDIDATE_SERVING_ID", "6bf3a503b5f44b89a0ca1aa25d082a83"
)
TEMPLATE_VERIFY_CANDIDATE_ENDPOINT_ID = env_template_id(
    "TEMPLATE_VERIFY_CANDIDATE_ENDPOINT_ID", "2a8436887c714f25b05ed7cd5223b56b"
)
