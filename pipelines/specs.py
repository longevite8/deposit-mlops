...
TRAINING_STEPS: tuple[PipelineStepSpec, ...] = (
    ...
    PipelineStepSpec(
        name="deploy_candidate_serving",
        template_id_name="TEMPLATE_DEPLOY_CANDIDATE_SERVING_ID",
        parents=("register",),
        parameter_override={
            ...
            "General/endpoint": config.CLEARML_CANDIDATE_SERVING_ENDPOINT,
            "General/endpoint_version": config.CLEARML_CANDIDATE_SERVING_ENDPOINT_VERSION,
    ...
    PipelineStepSpec(
        name="verify_candidate_endpoint",
        template_id_name="TEMPLATE_VERIFY_CANDIDATE_ENDPOINT_ID",
        parents=("deploy_candidate_serving",),
        parameter_override={
            "General/deploy_candidate_serving_task_id": "${deploy_candidate_serving.id}",
